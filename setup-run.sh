...
chcon -u system_u $ETC_DEST/profile.d
...
chcon -u system_u $USRLIB_DEST/coreos
...
chcon -u system_u $SYSTEMD_TMPFILES_DEST/coreos-profile.conf
chcon -u system_u $UDEV_RULES_DEST/91-issuegen.rules
chcon -u system_u $USRLIB_DEST/coreos/issue.d/base.issue
chcon -u system_u $USRSHARE_DEST/coreos/coreos-profile.sh
